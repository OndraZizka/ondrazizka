...
public class LeavePage extends BaseLayoutPage
{
   ...
   public LeavePage(PageParameters parameters) {
     ...
     freeResources.add( new ReservationWrap("jawa05", "ozizka", DateUtils.fromStringSQL("2010-05-14"), DateUtils.fromStringSQL("2010-05-14")) );
     freeResources.add( new ReservationWrap("jawa06", "ozizka", DateUtils.fromStringSQL("2010-05-14"), DateUtils.fromStringSQL("2010-05-15")) );
     freeResources.add( new ReservationWrap("jawa07", "ozizka", DateUtils.fromStringSQL("2010-05-16"), DateUtils.fromStringSQL("2010-05-16")) );
