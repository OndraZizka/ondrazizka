...
public class ChannelLinkPanel extends Panel {
   ...
   public ChannelLinkPanel( String id, final long userId ) {
      super( id );
      super.setDefaultModel( new Model( userManager.byID(userId)) );
   }

   public ChannelLinkPanel( String id, final String userName ) {
      super( id );
      super.setDefaultModel( new Model( userManager.byName(userName)) );
   }

   public ChannelLinkPanel( String id, final User user ) {
