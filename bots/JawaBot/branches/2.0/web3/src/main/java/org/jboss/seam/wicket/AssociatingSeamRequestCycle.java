 ...
 * @author Ondrej Zizka
 *    This only adds:
 *      conversationContext.associate( ((ServletWebRequest)request).getHttpServletRequest() );
 * 
 */
public class AssociatingSeamRequestCycle extends WebRequestCycle
{
   public AssociatingSeamRequestCycle(WebApplication application, WebRequest request, Response response)
   {
