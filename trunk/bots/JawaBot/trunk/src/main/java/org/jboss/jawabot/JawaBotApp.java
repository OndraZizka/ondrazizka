...
{
  private static Logger log = Logger.getLogger( JawaBotApp.class.getName()  );
  ...
  public static void main(String args[]) {
    ...
    final JawaBotApp app = new JawaBotApp();
    app.init( args );
    app.run( args );
   ...
   * Singleton stuff.
   */
  private static JawaBotApp instance;
  public static final JawaBotApp getInstance() {
    if( null == instance ) instance = new JawaBotApp();
    return instance;
  }
  ...
  // Constructor
  public JawaBotApp() {
    JawaBotApp.instance = this; // TODO: make private, use getInstance only.
  ...
  public void init( String[] args ){
    ...
    log = Logger.getLogger(JawaBotApp.class.getName());
  ...
  public void destroy(){
	...
	/**
	 * Creates and runs the JawaBot.
	 */
	public void createAndRunBot() throws IOException, IrcException
	{
