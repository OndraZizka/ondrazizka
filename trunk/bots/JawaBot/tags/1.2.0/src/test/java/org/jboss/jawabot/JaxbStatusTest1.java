...
import org.jboss.jawabot.state.JaxbStateWriter;
import org.jboss.jawabot.state.JaxbStateReader;
...
public class JaxbStatusTest1 /*extends TestCase*/ {
   ...
   public void XtestWrite() throws JawaBotIOException, JawaBotException, IOException {
      ...
      bot.resourceManager.bookResource("jawa01", "ozizka", today, today5 );
      bot.resourceManager.bookResource("jawa01", "oskutka", today6, today10 );
      bot.resourceManager.bookResource("jawa02", "ozizka", today, today10 );
