...
package org.jboss.jawabot.plugin.reserv.web._pg.test;
...
public class CheckBoxWrapListTestPage extends BaseLayoutPage
{
   ...
   @Inject @FromService ResourceManager resourceManager;
   ...
   public CheckBoxWrapListTestPage(PageParameters parameters) {
      ...
      CheckBoxWrapList<Resource> resources = new CheckBoxWrapList<Resource>( resourceManager.getResources_SortByName() );
